#ifndef QAHWA_NINFO_PARSER_HPP
#define QAHWA_NINFO_PARSER_HPP
#include<Qahwa/filestream/base/Parser.hpp>
#include<Qahwa/util/split_line.hpp>
#include<Qahwa/filestream/ninfo/ninfo_read_style/ninfo_read_style.hpp>
#include<Qahwa/filestream/ninfo/ninfo_read_style/ninfo_column_meaning.hpp>
#include<iostream>
#include<string>
#include<vector>
...
inline std::vector<std::string> NinfoParser<NINFO_SPC_SPL>::split_Line(const std::string& line) const {
	return Qahwa::strmanage::split_String(line, delim);
}
